...
train_dataset: Union[DatasetDict, Dataset, IterableDatasetDict, IterableDataset] = load_dataset("sentence-transformers/stsb", split="train")
eval_dataset: Union[DatasetDict, Dataset, IterableDatasetDict, IterableDataset] = load_dataset("sentence-transformers/stsb", split="validation")
test_dataset: Union[DatasetDict, Dataset, IterableDatasetDict, IterableDataset] = load_dataset("sentence-transformers/stsb", split="test")
...
dev_evaluator = EmbeddingSimilarityEvaluator(
    sentences1=eval_dataset["sentence1"], # type: ignore
    sentences2=eval_dataset["sentence2"], # type: ignore
    scores=eval_dataset["score"], # type: ignore
...
test_evaluator = EmbeddingSimilarityEvaluator(
    sentences1=test_dataset["sentence1"], # type: ignore
    sentences2=test_dataset["sentence2"], # type: ignore
    scores=test_dataset["score"], # type: ignore
    main_similarity=SimilarityFunction.COSINE,
    name="sts-test",
)
